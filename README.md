...
- `/反派魔女洗白 黑化原因`：与黑化日记共用存档、队友识别、关系总结和保存流程，但使用独立的反派魔女洗白 Prompt。命令后必须写本次黑化原因。
- `/反派魔女战斗 行动目标`：生成正文前会先选择完整战斗上下文；行动指向玩家战时从本城市魔法少女中选择目标，行动指向普通魔物、异常或污染源时从公共魔物书选择敌人。
- `/反派魔女日常`：使用独立的反派魔女日常 Prompt。角色没有反派组织、同僚或人类手下，像普通人一样上学、工作和生活；若角色卡有使魔/吉祥物，可作为生活陪伴出现。
- 公共魔物书是普通魔物敌人图鉴。魔法少女普通魔物战会从公共魔物书选择本次魔物，并使用开场钩子、适合地点、战斗机制和结束残留来减少公式化开场。
- 事件书是扁平事件列表；每个事件通过 `allowed_commands` 声明可被哪些指令触发，同一个事件可以同时服务魔法少女日常、反派魔女日常和战斗命令。
